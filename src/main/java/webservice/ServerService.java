 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://Source/", wsdlLocation = "http://localhost:8080/CarRental?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://Source/", "ServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CarRental?wsdl");
    ...
    public Server getServerPort() {
        return super.getPort(new QName("http://Source/", "ServerPort"), Server.class);
    }
    ...
    public Server getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Source/", "ServerPort"), Server.class, features);
    }
